...
function fixedfooter() {
    ...
    function template() {
        return [
            ...
            '<div class="col-xs-12">',
            '<p>Hours of Assistance: 8am to 8pm EST M-F</p>',
            '<p><i class="fa fa-envelope-square"></i>&nbsp;<a href="mailto:TAC@taylorcommunications.com">TAC@taylorcommunications.com</a></p>',
            '<p><i class="fa fa-phone-square"></i>&nbsp;<a href="tel:877-885-9500">877-885-9500</a> Option 2</p>',
            '</div>',
            '</div>',
            '</div>',
            '</div>',
